...
INSERT INTO tags (uuid, display_name, updated_at, deleted_at, server_updated_at) VALUES
  ...
  ('50000000-0000-0000-0000-00000000000b', 'Kid-Friendly', 11, NULL, now()),
  ('50000000-0000-0000-0000-00000000000c', 'Comfort Food', 12, NULL, now()),
  ('50000000-0000-0000-0000-00000000000d', 'Budget', 13, NULL, now()),
  ('50000000-0000-0000-0000-00000000000e', 'Healthy', 14, NULL, now()),
  ('50000000-0000-0000-0000-00000000000f', 'Sandwich', 15, NULL, now()),
  ('50000000-0000-0000-0000-000000000010', 'Air Fryer', 16, NULL, now());
...
INSERT INTO recipes (uuid, title, description, image_url, image_url_thumbnail, prep_time_minutes, cook_time_minutes, servings, creator_id, recipe_external_url, privacy, updated_at, deleted_at, server_updated_at) VALUES
  ...
  ('a1b2c3d4-0000-0000-0000-000000000012','Mediterranean Chicken','Grilled chicken with olives and feta.','https://raw.githubusercontent.com/jmuci/ChATestAPI/refs/heads/main/statics/thumbnails/lowres/chicken-med.jpeg','https://raw.githubusercontent.com/jmuci/ChATestAPI/refs/heads/main/statics/thumbnails/lowres/chicken-med.jpeg',15,25,3,'1ff5c5d2-dda5-4a7d-9df2-0b1d79878fd7',NULL,'PUBLIC',12,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000013','Battered Cod','Crispy beer-battered cod fillets.','https://raw.githubusercontent.com/jmuci/ChATestAPI/refs/heads/main/statics/thumbnails/lowres/shrimp_ceviche.jpeg','https://raw.githubusercontent.com/jmuci/ChATestAPI/refs/heads/main/statics/thumbnails/lowres/shrimp_ceviche.jpeg',15,10,2,'1ff5c5d2-dda5-4a7d-9df2-0b1d79878fd7',NULL,'PUBLIC',13,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000014','Chocolate Chip Cookies','Classic soft-baked cookies.','https://images.unsplash.com/photo-1499636136210-6f4ee915583e?q=80&w=1064&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D','https://images.unsplash.com/photo-1499636136210-6f4ee915583e?q=80&w=1064&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',15,12,24,'1ff5c5d2-dda5-4a7d-9df2-0b1d79878fd7',NULL,'PUBLIC',14,NULL,now()),
...
INSERT INTO recipe_ingredients (recipe_id, ingredient_id, quantity, unit, updated_at, deleted_at, server_updated_at) VALUES
  ('70000000-0000-0000-0000-000000000001','60000000-0000-0000-0000-00000000000b',10,'g',1,NULL,now()),
  ('70000000-0000-0000-0000-000000000001','60000000-0000-0000-0000-00000000000c',50,'g',1,NULL,now()),
  ('70000000-0000-0000-0000-000000000002','60000000-0000-0000-0000-000000000006',80,'g',2,NULL,now()),
  ('70000000-0000-0000-0000-000000000002','60000000-0000-0000-0000-00000000000b',10,'g',2,NULL,now()),
  ('70000000-0000-0000-0000-000000000003','60000000-0000-0000-0000-00000000000c',80,'g',3,NULL,now()),
  ('70000000-0000-0000-0000-000000000003','60000000-0000-0000-0000-00000000000b',10,'g',3,NULL,now()),
  ('70000000-0000-0000-0000-000000000004','60000000-0000-0000-0000-00000000000d',60,'g',4,NULL,now()),
  ('70000000-0000-0000-0000-000000000004','60000000-0000-0000-0000-00000000000b',10,'g',4,NULL,now()),
  ('70000000-0000-0000-0000-000000000005','60000000-0000-0000-0000-000000000003',50,'ml',5,NULL,now()),
  ('70000000-0000-0000-0000-000000000005','60000000-0000-0000-0000-000000000006',30,'g',5,NULL,now()),
  ('70000000-0000-0000-0000-000000000006','60000000-0000-0000-0000-000000000012',80,'g',6,NULL,now()),
  ('70000000-0000-0000-0000-000000000006','60000000-0000-0000-0000-000000000013',50,'g',6,NULL,now()),
  ('70000000-0000-0000-0000-000000000007','60000000-0000-0000-0000-000000000002',2,'pcs',7,NULL,now()),
  ('70000000-0000-0000-0000-000000000007','60000000-0000-0000-0000-000000000008',20,'g',7,NULL,now()),
  ('70000000-0000-0000-0000-000000000008','60000000-0000-0000-0000-000000000002',2,'pcs',8,NULL,now()),
  ('70000000-0000-0000-0000-000000000008','60000000-0000-0000-0000-000000000003',60,'ml',8,NULL,now()),
  ('70000000-0000-0000-0000-000000000009','60000000-0000-0000-0000-000000000002',2,'pcs',9,NULL,now()),
  ('70000000-0000-0000-0000-000000000009','60000000-0000-0000-0000-000000000005',100,'g',9,NULL,now()),
  ('70000000-0000-0000-0000-00000000000a','60000000-0000-0000-0000-00000000000b',10,'g',10,NULL,now()),
  ('70000000-0000-0000-0000-00000000000a','60000000-0000-0000-0000-00000000000c',50,'g',10,NULL,now()),
  ('70000000-0000-0000-0000-00000000000b','60000000-0000-0000-0000-00000000000c',60,'g',11,NULL,now()),
  ('70000000-0000-0000-0000-00000000000b','60000000-0000-0000-0000-00000000000d',80,'g',11,NULL,now()),
  ('70000000-0000-0000-0000-00000000000c','60000000-0000-0000-0000-00000000000a',120,'g',12,NULL,now()),
  ('70000000-0000-0000-0000-00000000000c','60000000-0000-0000-0000-00000000000b',10,'g',12,NULL,now()),
  ('70000000-0000-0000-0000-00000000000d','60000000-0000-0000-0000-00000000000c',60,'g',13,NULL,now()),
  ('70000000-0000-0000-0000-00000000000d','60000000-0000-0000-0000-00000000000b',10,'g',13,NULL,now()),
  ('70000000-0000-0000-0000-00000000000e','60000000-0000-0000-0000-00000000000b',10,'g',14,NULL,now()),
  ('70000000-0000-0000-0000-00000000000e','60000000-0000-0000-0000-000000000006',50,'g',14,NULL,now()),
  ('70000000-0000-0000-0000-00000000000f','60000000-0000-0000-0000-000000000007',30,'g',15,NULL,now()),
  ('70000000-0000-0000-0000-00000000000f','60000000-0000-0000-0000-00000000000b',8,'g',15,NULL,now()),
  ('70000000-0000-0000-0000-000000000010','60000000-0000-0000-0000-00000000000c',80,'g',16,NULL,now()),
  ('70000000-0000-0000-0000-000000000010','60000000-0000-0000-0000-00000000000b',10,'g',16,NULL,now()),
  ('70000000-0000-0000-0000-000000000011','60000000-0000-0000-0000-000000000013',50,'g',17,NULL,now()),
  ('70000000-0000-0000-0000-000000000011','60000000-0000-0000-0000-000000000003',100,'ml',17,NULL,now()),
  ('70000000-0000-0000-0000-000000000012','60000000-0000-0000-0000-000000000007',60,'g',18,NULL,now()),
  ('70000000-0000-0000-0000-000000000012','60000000-0000-0000-0000-000000000003',80,'ml',18,NULL,now()),
  ('70000000-0000-0000-0000-000000000013','60000000-0000-0000-0000-000000000007',30,'g',19,NULL,now()),
  ('70000000-0000-0000-0000-000000000013','60000000-0000-0000-0000-000000000005',80,'g',19,NULL,now()),
  ('70000000-0000-0000-0000-000000000014','60000000-0000-0000-0000-00000000000b',10,'g',20,NULL,now()),
  ('70000000-0000-0000-0000-000000000014','60000000-0000-0000-0000-000000000006',60,'g',20,NULL,now())
ON CONFLICT (recipe_id, ingredient_id) DO NOTHING;

-- Ingredients: test recipes 015–046 (4 per recipe)
INSERT INTO recipe_ingredients (recipe_id, ingredient_id, quantity, unit, updated_at, deleted_at, server_updated_at) VALUES
  ('70000000-0000-0000-0000-000000000015','60000000-0000-0000-0000-000000000004',150,'g',21,NULL,now()),
  ('70000000-0000-0000-0000-000000000015','60000000-0000-0000-0000-00000000000a',120,'g',21,NULL,now()),
  ('70000000-0000-0000-0000-000000000015','60000000-0000-0000-0000-00000000000b',10,'g',21,NULL,now()),
  ('70000000-0000-0000-0000-000000000015','60000000-0000-0000-0000-00000000000c',60,'g',21,NULL,now()),
  ('70000000-0000-0000-0000-000000000016','60000000-0000-0000-0000-000000000004',150,'g',22,NULL,now()),
  ('70000000-0000-0000-0000-000000000016','60000000-0000-0000-0000-00000000000a',120,'g',22,NULL,now()),
  ('70000000-0000-0000-0000-000000000016','60000000-0000-0000-0000-00000000000b',10,'g',22,NULL,now()),
  ('70000000-0000-0000-0000-000000000016','60000000-0000-0000-0000-00000000000c',60,'g',22,NULL,now()),
  ('70000000-0000-0000-0000-000000000017','60000000-0000-0000-0000-000000000004',150,'g',23,NULL,now()),
  ('70000000-0000-0000-0000-000000000017','60000000-0000-0000-0000-00000000000a',120,'g',23,NULL,now()),
  ('70000000-0000-0000-0000-000000000017','60000000-0000-0000-0000-00000000000b',10,'g',23,NULL,now()),
  ('70000000-0000-0000-0000-000000000017','60000000-0000-0000-0000-00000000000c',60,'g',23,NULL,now()),
  ('70000000-0000-0000-0000-000000000018','60000000-0000-0000-0000-000000000004',150,'g',24,NULL,now()),
  ('70000000-0000-0000-0000-000000000018','60000000-0000-0000-0000-00000000000a',120,'g',24,NULL,now()),
  ('70000000-0000-0000-0000-000000000018','60000000-0000-0000-0000-00000000000b',10,'g',24,NULL,now()),
  ('70000000-0000-0000-0000-000000000018','60000000-0000-0000-0000-00000000000c',60,'g',24,NULL,now()),
  ('70000000-0000-0000-0000-000000000019','60000000-0000-0000-0000-000000000004',150,'g',25,NULL,now()),
  ('70000000-0000-0000-0000-000000000019','60000000-0000-0000-0000-00000000000a',120,'g',25,NULL,now()),
  ('70000000-0000-0000-0000-000000000019','60000000-0000-0000-0000-00000000000b',10,'g',25,NULL,now()),
  ('70000000-0000-0000-0000-000000000019','60000000-0000-0000-0000-00000000000c',60,'g',25,NULL,now()),
  ('70000000-0000-0000-0000-00000000001a','60000000-0000-0000-0000-000000000004',150,'g',26,NULL,now()),
  ('70000000-0000-0000-0000-00000000001a','60000000-0000-0000-0000-00000000000a',120,'g',26,NULL,now()),
  ('70000000-0000-0000-0000-00000000001a','60000000-0000-0000-0000-00000000000b',10,'g',26,NULL,now()),
  ('70000000-0000-0000-0000-00000000001a','60000000-0000-0000-0000-00000000000c',60,'g',26,NULL,now()),
  ('70000000-0000-0000-0000-00000000001b','60000000-0000-0000-0000-000000000004',150,'g',27,NULL,now()),
  ('70000000-0000-0000-0000-00000000001b','60000000-0000-0000-0000-00000000000a',120,'g',27,NULL,now()),
  ('70000000-0000-0000-0000-00000000001b','60000000-0000-0000-0000-00000000000b',10,'g',27,NULL,now()),
  ('70000000-0000-0000-0000-00000000001b','60000000-0000-0000-0000-00000000000c',60,'g',27,NULL,now()),
  ('70000000-0000-0000-0000-00000000001c','60000000-0000-0000-0000-000000000004',150,'g',28,NULL,now()),
  ('70000000-0000-0000-0000-00000000001c','60000000-0000-0000-0000-00000000000a',120,'g',28,NULL,now()),
  ('70000000-0000-0000-0000-00000000001c','60000000-0000-0000-0000-00000000000b',10,'g',28,NULL,now()),
  ('70000000-0000-0000-0000-00000000001c','60000000-0000-0000-0000-00000000000c',60,'g',28,NULL,now()),
  ('70000000-0000-0000-0000-00000000001d','60000000-0000-0000-0000-000000000004',150,'g',29,NULL,now()),
  ('70000000-0000-0000-0000-00000000001d','60000000-0000-0000-0000-00000000000a',120,'g',29,NULL,now()),
  ('70000000-0000-0000-0000-00000000001d','60000000-0000-0000-0000-00000000000b',10,'g',29,NULL,now()),
  ('70000000-0000-0000-0000-00000000001d','60000000-0000-0000-0000-00000000000c',60,'g',29,NULL,now()),
  ('70000000-0000-0000-0000-00000000001e','60000000-0000-0000-0000-000000000004',150,'g',30,NULL,now()),
  ('70000000-0000-0000-0000-00000000001e','60000000-0000-0000-0000-00000000000a',120,'g',30,NULL,now()),
  ('70000000-0000-0000-0000-00000000001e','60000000-0000-0000-0000-00000000000b',10,'g',30,NULL,now()),
  ('70000000-0000-0000-0000-00000000001e','60000000-0000-0000-0000-00000000000c',60,'g',30,NULL,now()),
  ('70000000-0000-0000-0000-00000000001f','60000000-0000-0000-0000-00000000000f',150,'g',31,NULL,now()),
  ('70000000-0000-0000-0000-00000000001f','60000000-0000-0000-0000-000000000005',120,'g',31,NULL,now()),
  ('70000000-0000-0000-0000-00000000001f','60000000-0000-0000-0000-000000000006',10,'g',31,NULL,now()),
  ('70000000-0000-0000-0000-00000000001f','60000000-0000-0000-0000-00000000000e',60,'g',31,NULL,now()),
  ('70000000-0000-0000-0000-000000000020','60000000-0000-0000-0000-00000000000f',150,'g',32,NULL,now()),
  ('70000000-0000-0000-0000-000000000020','60000000-0000-0000-0000-000000000005',120,'g',32,NULL,now()),
  ('70000000-0000-0000-0000-000000000020','60000000-0000-0000-0000-000000000006',10,'g',32,NULL,now()),
  ('70000000-0000-0000-0000-000000000020','60000000-0000-0000-0000-00000000000e',60,'g',32,NULL,now()),
  ('70000000-0000-0000-0000-000000000021','60000000-0000-0000-0000-00000000000f',150,'g',33,NULL,now()),
  ('70000000-0000-0000-0000-000000000021','60000000-0000-0000-0000-000000000005',120,'g',33,NULL,now()),
  ('70000000-0000-0000-0000-000000000021','60000000-0000-0000-0000-000000000006',10,'g',33,NULL,now()),
  ('70000000-0000-0000-0000-000000000021','60000000-0000-0000-0000-00000000000e',60,'g',33,NULL,now()),
  ('70000000-0000-0000-0000-000000000022','60000000-0000-0000-0000-00000000000f',150,'g',34,NULL,now()),
  ('70000000-0000-0000-0000-000000000022','60000000-0000-0000-0000-000000000005',120,'g',34,NULL,now()),
  ('70000000-0000-0000-0000-000000000022','60000000-0000-0000-0000-000000000006',10,'g',34,NULL,now()),
  ('70000000-0000-0000-0000-000000000022','60000000-0000-0000-0000-00000000000e',60,'g',34,NULL,now()),
  ('70000000-0000-0000-0000-000000000023','60000000-0000-0000-0000-00000000000f',150,'g',35,NULL,now()),
  ('70000000-0000-0000-0000-000000000023','60000000-0000-0000-0000-000000000005',120,'g',35,NULL,now()),
  ('70000000-0000-0000-0000-000000000023','60000000-0000-0000-0000-000000000006',10,'g',35,NULL,now()),
  ('70000000-0000-0000-0000-000000000023','60000000-0000-0000-0000-00000000000e',60,'g',35,NULL,now()),
  ('70000000-0000-0000-0000-000000000024','60000000-0000-0000-0000-00000000000f',150,'g',36,NULL,now()),
  ('70000000-0000-0000-0000-000000000024','60000000-0000-0000-0000-000000000005',120,'g',36,NULL,now()),
  ('70000000-0000-0000-0000-000000000024','60000000-0000-0000-0000-000000000006',10,'g',36,NULL,now()),
  ('70000000-0000-0000-0000-000000000024','60000000-0000-0000-0000-00000000000e',60,'g',36,NULL,now()),
  ('70000000-0000-0000-0000-000000000025','60000000-0000-0000-0000-00000000000f',150,'g',37,NULL,now()),
  ('70000000-0000-0000-0000-000000000025','60000000-0000-0000-0000-000000000005',120,'g',37,NULL,now()),
  ('70000000-0000-0000-0000-000000000025','60000000-0000-0000-0000-000000000006',10,'g',37,NULL,now()),
  ('70000000-0000-0000-0000-000000000025','60000000-0000-0000-0000-00000000000e',60,'g',37,NULL,now()),
  ('70000000-0000-0000-0000-000000000026','60000000-0000-0000-0000-00000000000f',150,'g',38,NULL,now()),
  ('70000000-0000-0000-0000-000000000026','60000000-0000-0000-0000-000000000005',120,'g',38,NULL,now()),
  ('70000000-0000-0000-0000-000000000026','60000000-0000-0000-0000-000000000006',10,'g',38,NULL,now()),
  ('70000000-0000-0000-0000-000000000026','60000000-0000-0000-0000-00000000000e',60,'g',38,NULL,now()),
  ('70000000-0000-0000-0000-000000000027','60000000-0000-0000-0000-00000000000f',150,'g',39,NULL,now()),
  ('70000000-0000-0000-0000-000000000027','60000000-0000-0000-0000-000000000005',120,'g',39,NULL,now()),
  ('70000000-0000-0000-0000-000000000027','60000000-0000-0000-0000-000000000006',10,'g',39,NULL,now()),
  ('70000000-0000-0000-0000-000000000027','60000000-0000-0000-0000-00000000000e',60,'g',39,NULL,now()),
  ('70000000-0000-0000-0000-000000000028','60000000-0000-0000-0000-00000000000f',150,'g',40,NULL,now()),
  ('70000000-0000-0000-0000-000000000028','60000000-0000-0000-0000-000000000005',120,'g',40,NULL,now()),
  ('70000000-0000-0000-0000-000000000028','60000000-0000-0000-0000-000000000006',10,'g',40,NULL,now()),
  ('70000000-0000-0000-0000-000000000028','60000000-0000-0000-0000-00000000000e',60,'g',40,NULL,now()),
  ('70000000-0000-0000-0000-000000000029','60000000-0000-0000-0000-000000000009',150,'g',41,NULL,now()),
  ('70000000-0000-0000-0000-000000000029','60000000-0000-0000-0000-000000000014',120,'g',41,NULL,now()),
  ('70000000-0000-0000-0000-000000000029','60000000-0000-0000-0000-000000000002',10,'g',41,NULL,now()),
  ('70000000-0000-0000-0000-000000000029','60000000-0000-0000-0000-000000000007',60,'g',41,NULL,now()),
  ('70000000-0000-0000-0000-00000000002a','60000000-0000-0000-0000-000000000009',150,'g',42,NULL,now()),
  ('70000000-0000-0000-0000-00000000002a','60000000-0000-0000-0000-000000000014',120,'g',42,NULL,now()),
  ('70000000-0000-0000-0000-00000000002a','60000000-0000-0000-0000-000000000002',10,'g',42,NULL,now()),
  ('70000000-0000-0000-0000-00000000002a','60000000-0000-0000-0000-000000000007',60,'g',42,NULL,now()),
  ('70000000-0000-0000-0000-00000000002b','60000000-0000-0000-0000-000000000009',150,'g',43,NULL,now()),
  ('70000000-0000-0000-0000-00000000002b','60000000-0000-0000-0000-000000000014',120,'g',43,NULL,now()),
  ('70000000-0000-0000-0000-00000000002b','60000000-0000-0000-0000-000000000002',10,'g',43,NULL,now()),
  ('70000000-0000-0000-0000-00000000002b','60000000-0000-0000-0000-000000000007',60,'g',43,NULL,now()),
  ('70000000-0000-0000-0000-00000000002c','60000000-0000-0000-0000-000000000009',150,'g',44,NULL,now()),
  ('70000000-0000-0000-0000-00000000002c','60000000-0000-0000-0000-000000000014',120,'g',44,NULL,now()),
  ('70000000-0000-0000-0000-00000000002c','60000000-0000-0000-0000-000000000002',10,'g',44,NULL,now()),
  ('70000000-0000-0000-0000-00000000002c','60000000-0000-0000-0000-000000000007',60,'g',44,NULL,now()),
  ('70000000-0000-0000-0000-00000000002d','60000000-0000-0000-0000-000000000009',150,'g',45,NULL,now()),
  ('70000000-0000-0000-0000-00000000002d','60000000-0000-0000-0000-000000000014',120,'g',45,NULL,now()),
  ('70000000-0000-0000-0000-00000000002d','60000000-0000-0000-0000-000000000002',10,'g',45,NULL,now()),
  ('70000000-0000-0000-0000-00000000002d','60000000-0000-0000-0000-000000000007',60,'g',45,NULL,now()),
  ('70000000-0000-0000-0000-00000000002e','60000000-0000-0000-0000-000000000009',150,'g',46,NULL,now()),
  ('70000000-0000-0000-0000-00000000002e','60000000-0000-0000-0000-000000000014',120,'g',46,NULL,now()),
  ('70000000-0000-0000-0000-00000000002e','60000000-0000-0000-0000-000000000002',10,'g',46,NULL,now()),
  ('70000000-0000-0000-0000-00000000002e','60000000-0000-0000-0000-000000000007',60,'g',46,NULL,now()),
  ('70000000-0000-0000-0000-00000000002f','60000000-0000-0000-0000-000000000009',150,'g',47,NULL,now()),
  ('70000000-0000-0000-0000-00000000002f','60000000-0000-0000-0000-000000000014',120,'g',47,NULL,now()),
  ('70000000-0000-0000-0000-00000000002f','60000000-0000-0000-0000-000000000002',10,'g',47,NULL,now()),
  ('70000000-0000-0000-0000-00000000002f','60000000-0000-0000-0000-000000000007',60,'g',47,NULL,now()),
  ('70000000-0000-0000-0000-000000000030','60000000-0000-0000-0000-000000000009',150,'g',48,NULL,now()),
  ('70000000-0000-0000-0000-000000000030','60000000-0000-0000-0000-000000000014',120,'g',48,NULL,now()),
  ('70000000-0000-0000-0000-000000000030','60000000-0000-0000-0000-000000000002',10,'g',48,NULL,now()),
  ('70000000-0000-0000-0000-000000000030','60000000-0000-0000-0000-000000000007',60,'g',48,NULL,now()),
  ('70000000-0000-0000-0000-000000000031','60000000-0000-0000-0000-000000000009',150,'g',49,NULL,now()),
  ('70000000-0000-0000-0000-000000000031','60000000-0000-0000-0000-000000000014',120,'g',49,NULL,now()),
  ('70000000-0000-0000-0000-000000000031','60000000-0000-0000-0000-000000000002',10,'g',49,NULL,now()),
  ('70000000-0000-0000-0000-000000000031','60000000-0000-0000-0000-000000000007',60,'g',49,NULL,now()),
  ('70000000-0000-0000-0000-000000000032','60000000-0000-0000-0000-000000000009',150,'g',50,NULL,now()),
  ('70000000-0000-0000-0000-000000000032','60000000-0000-0000-0000-000000000014',120,'g',50,NULL,now()),
  ('70000000-0000-0000-0000-000000000032','60000000-0000-0000-0000-000000000002',10,'g',50,NULL,now()),
  ('70000000-0000-0000-0000-000000000032','60000000-0000-0000-0000-000000000007',60,'g',50,NULL,now()),
  ('70000000-0000-0000-0000-000000000033','60000000-0000-0000-0000-000000000011',150,'g',51,NULL,now()),
  ('70000000-0000-0000-0000-000000000033','60000000-0000-0000-0000-000000000001',120,'g',51,NULL,now()),
  ('70000000-0000-0000-0000-000000000033','60000000-0000-0000-0000-000000000003',10,'g',51,NULL,now()),
  ('70000000-0000-0000-0000-000000000033','60000000-0000-0000-0000-000000000008',60,'g',51,NULL,now()),
  ('70000000-0000-0000-0000-000000000034','60000000-0000-0000-0000-000000000011',150,'g',52,NULL,now()),
  ('70000000-0000-0000-0000-000000000034','60000000-0000-0000-0000-000000000001',120,'g',52,NULL,now()),
  ('70000000-0000-0000-0000-000000000034','60000000-0000-0000-0000-000000000003',10,'g',52,NULL,now()),
  ('70000000-0000-0000-0000-000000000034','60000000-0000-0000-0000-000000000008',60,'g',52,NULL,now()),
  ('70000000-0000-0000-0000-000000000035','60000000-0000-0000-0000-000000000011',150,'g',53,NULL,now()),
  ('70000000-0000-0000-0000-000000000035','60000000-0000-0000-0000-000000000001',120,'g',53,NULL,now()),
  ('70000000-0000-0000-0000-000000000035','60000000-0000-0000-0000-000000000003',10,'g',53,NULL,now()),
  ('70000000-0000-0000-0000-000000000035','60000000-0000-0000-0000-000000000008',60,'g',53,NULL,now()),
  ('70000000-0000-0000-0000-000000000036','60000000-0000-0000-0000-000000000011',150,'g',54,NULL,now()),
  ('70000000-0000-0000-0000-000000000036','60000000-0000-0000-0000-000000000001',120,'g',54,NULL,now()),
  ('70000000-0000-0000-0000-000000000036','60000000-0000-0000-0000-000000000003',10,'g',54,NULL,now()),
  ('70000000-0000-0000-0000-000000000036','60000000-0000-0000-0000-000000000008',60,'g',54,NULL,now()),
  ('70000000-0000-0000-0000-000000000037','60000000-0000-0000-0000-000000000011',150,'g',55,NULL,now()),
  ('70000000-0000-0000-0000-000000000037','60000000-0000-0000-0000-000000000001',120,'g',55,NULL,now()),
  ('70000000-0000-0000-0000-000000000037','60000000-0000-0000-0000-000000000003',10,'g',55,NULL,now()),
  ('70000000-0000-0000-0000-000000000037','60000000-0000-0000-0000-000000000008',60,'g',55,NULL,now()),
  ('70000000-0000-0000-0000-000000000038','60000000-0000-0000-0000-000000000011',150,'g',56,NULL,now()),
  ('70000000-0000-0000-0000-000000000038','60000000-0000-0000-0000-000000000001',120,'g',56,NULL,now()),
  ('70000000-0000-0000-0000-000000000038','60000000-0000-0000-0000-000000000003',10,'g',56,NULL,now()),
  ('70000000-0000-0000-0000-000000000038','60000000-0000-0000-0000-000000000008',60,'g',56,NULL,now()),
  ('70000000-0000-0000-0000-000000000039','60000000-0000-0000-0000-000000000011',150,'g',57,NULL,now()),
  ('70000000-0000-0000-0000-000000000039','60000000-0000-0000-0000-000000000001',120,'g',57,NULL,now()),
  ('70000000-0000-0000-0000-000000000039','60000000-0000-0000-0000-000000000003',10,'g',57,NULL,now()),
  ('70000000-0000-0000-0000-000000000039','60000000-0000-0000-0000-000000000008',60,'g',57,NULL,now()),
  ('70000000-0000-0000-0000-00000000003a','60000000-0000-0000-0000-000000000011',150,'g',58,NULL,now()),
  ('70000000-0000-0000-0000-00000000003a','60000000-0000-0000-0000-000000000001',120,'g',58,NULL,now()),
  ('70000000-0000-0000-0000-00000000003a','60000000-0000-0000-0000-000000000003',10,'g',58,NULL,now()),
  ('70000000-0000-0000-0000-00000000003a','60000000-0000-0000-0000-000000000008',60,'g',58,NULL,now()),
  ('70000000-0000-0000-0000-00000000003b','60000000-0000-0000-0000-000000000011',150,'g',59,NULL,now()),
  ('70000000-0000-0000-0000-00000000003b','60000000-0000-0000-0000-000000000001',120,'g',59,NULL,now()),
  ('70000000-0000-0000-0000-00000000003b','60000000-0000-0000-0000-000000000003',10,'g',59,NULL,now()),
  ('70000000-0000-0000-0000-00000000003b','60000000-0000-0000-0000-000000000008',60,'g',59,NULL,now()),
  ('70000000-0000-0000-0000-00000000003c','60000000-0000-0000-0000-000000000011',150,'g',60,NULL,now()),
  ('70000000-0000-0000-0000-00000000003c','60000000-0000-0000-0000-000000000001',120,'g',60,NULL,now()),
  ('70000000-0000-0000-0000-00000000003c','60000000-0000-0000-0000-000000000003',10,'g',60,NULL,now()),
  ('70000000-0000-0000-0000-00000000003c','60000000-0000-0000-0000-000000000008',60,'g',60,NULL,now()),
  ('70000000-0000-0000-0000-00000000003d','60000000-0000-0000-0000-000000000010',150,'g',61,NULL,now()),
  ('70000000-0000-0000-0000-00000000003d','60000000-0000-0000-0000-000000000012',120,'g',61,NULL,now()),
  ('70000000-0000-0000-0000-00000000003d','60000000-0000-0000-0000-000000000013',10,'g',61,NULL,now()),
  ('70000000-0000-0000-0000-00000000003d','60000000-0000-0000-0000-00000000000d',60,'g',61,NULL,now()),
  ('70000000-0000-0000-0000-00000000003e','60000000-0000-0000-0000-000000000010',150,'g',62,NULL,now()),
  ('70000000-0000-0000-0000-00000000003e','60000000-0000-0000-0000-000000000012',120,'g',62,NULL,now()),
  ('70000000-0000-0000-0000-00000000003e','60000000-0000-0000-0000-000000000013',10,'g',62,NULL,now()),
  ('70000000-0000-0000-0000-00000000003e','60000000-0000-0000-0000-00000000000d',60,'g',62,NULL,now()),
  ('70000000-0000-0000-0000-00000000003f','60000000-0000-0000-0000-000000000010',150,'g',63,NULL,now()),
  ('70000000-0000-0000-0000-00000000003f','60000000-0000-0000-0000-000000000012',120,'g',63,NULL,now()),
  ('70000000-0000-0000-0000-00000000003f','60000000-0000-0000-0000-000000000013',10,'g',63,NULL,now()),
  ('70000000-0000-0000-0000-00000000003f','60000000-0000-0000-0000-00000000000d',60,'g',63,NULL,now()),
  ('70000000-0000-0000-0000-000000000040','60000000-0000-0000-0000-000000000010',150,'g',64,NULL,now()),
  ('70000000-0000-0000-0000-000000000040','60000000-0000-0000-0000-000000000012',120,'g',64,NULL,now()),
  ('70000000-0000-0000-0000-000000000040','60000000-0000-0000-0000-000000000013',10,'g',64,NULL,now()),
  ('70000000-0000-0000-0000-000000000040','60000000-0000-0000-0000-00000000000d',60,'g',64,NULL,now()),
  ('70000000-0000-0000-0000-000000000041','60000000-0000-0000-0000-000000000010',150,'g',65,NULL,now()),
  ('70000000-0000-0000-0000-000000000041','60000000-0000-0000-0000-000000000012',120,'g',65,NULL,now()),
  ('70000000-0000-0000-0000-000000000041','60000000-0000-0000-0000-000000000013',10,'g',65,NULL,now()),
  ('70000000-0000-0000-0000-000000000041','60000000-0000-0000-0000-00000000000d',60,'g',65,NULL,now()),
  ('70000000-0000-0000-0000-000000000042','60000000-0000-0000-0000-000000000010',150,'g',66,NULL,now()),
  ('70000000-0000-0000-0000-000000000042','60000000-0000-0000-0000-000000000012',120,'g',66,NULL,now()),
  ('70000000-0000-0000-0000-000000000042','60000000-0000-0000-0000-000000000013',10,'g',66,NULL,now()),
  ('70000000-0000-0000-0000-000000000042','60000000-0000-0000-0000-00000000000d',60,'g',66,NULL,now()),
  ('70000000-0000-0000-0000-000000000043','60000000-0000-0000-0000-000000000010',150,'g',67,NULL,now()),
  ('70000000-0000-0000-0000-000000000043','60000000-0000-0000-0000-000000000012',120,'g',67,NULL,now()),
  ('70000000-0000-0000-0000-000000000043','60000000-0000-0000-0000-000000000013',10,'g',67,NULL,now()),
  ('70000000-0000-0000-0000-000000000043','60000000-0000-0000-0000-00000000000d',60,'g',67,NULL,now()),
  ('70000000-0000-0000-0000-000000000044','60000000-0000-0000-0000-000000000010',150,'g',68,NULL,now()),
  ('70000000-0000-0000-0000-000000000044','60000000-0000-0000-0000-000000000012',120,'g',68,NULL,now()),
  ('70000000-0000-0000-0000-000000000044','60000000-0000-0000-0000-000000000013',10,'g',68,NULL,now()),
  ('70000000-0000-0000-0000-000000000044','60000000-0000-0000-0000-00000000000d',60,'g',68,NULL,now()),
  ('70000000-0000-0000-0000-000000000045','60000000-0000-0000-0000-000000000010',150,'g',69,NULL,now()),
  ('70000000-0000-0000-0000-000000000045','60000000-0000-0000-0000-000000000012',120,'g',69,NULL,now()),
  ('70000000-0000-0000-0000-000000000045','60000000-0000-0000-0000-000000000013',10,'g',69,NULL,now()),
  ('70000000-0000-0000-0000-000000000045','60000000-0000-0000-0000-00000000000d',60,'g',69,NULL,now()),
  ('70000000-0000-0000-0000-000000000046','60000000-0000-0000-0000-000000000010',150,'g',70,NULL,now()),
  ('70000000-0000-0000-0000-000000000046','60000000-0000-0000-0000-000000000012',120,'g',70,NULL,now()),
  ('70000000-0000-0000-0000-000000000046','60000000-0000-0000-0000-000000000013',10,'g',70,NULL,now()),
  ('70000000-0000-0000-0000-000000000046','60000000-0000-0000-0000-00000000000d',60,'g',70,NULL,now())
ON CONFLICT (recipe_id, ingredient_id) DO NOTHING;

-- Ingredients: featured recipes a001–a016
INSERT INTO recipe_ingredients (recipe_id, ingredient_id, quantity, unit, updated_at, deleted_at, server_updated_at) VALUES
  ('a1b2c3d4-0000-0000-0000-000000000001','60000000-0000-0000-0000-000000000011',200,'g',1,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000001','60000000-0000-0000-0000-00000000000a',150,'g',1,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000001','60000000-0000-0000-0000-000000000005',100,'g',1,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000001','60000000-0000-0000-0000-00000000000b',10,'g',1,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000001','60000000-0000-0000-0000-00000000000c',60,'g',1,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000002','60000000-0000-0000-0000-000000000004',250,'g',2,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000002','60000000-0000-0000-0000-00000000000b',15,'g',2,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000002','60000000-0000-0000-0000-00000000000c',80,'g',2,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000002','60000000-0000-0000-0000-000000000006',50,'g',2,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000003','60000000-0000-0000-0000-000000000004',250,'g',3,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000003','60000000-0000-0000-0000-000000000003',200,'ml',3,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000003','60000000-0000-0000-0000-00000000000b',15,'g',3,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000003','60000000-0000-0000-0000-00000000000d',100,'g',3,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000003','60000000-0000-0000-0000-000000000006',80,'g',3,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000004','60000000-0000-0000-0000-000000000001',250,'g',4,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000004','60000000-0000-0000-0000-000000000005',150,'g',4,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000004','60000000-0000-0000-0000-000000000007',100,'g',4,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000004','60000000-0000-0000-0000-00000000000b',10,'g',4,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000005','60000000-0000-0000-0000-00000000000f',400,'g',5,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000005','60000000-0000-0000-0000-00000000000c',150,'g',5,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000005','60000000-0000-0000-0000-00000000000b',15,'g',5,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000005','60000000-0000-0000-0000-000000000005',200,'g',5,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000005','60000000-0000-0000-0000-00000000000e',100,'g',5,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000006','60000000-0000-0000-0000-000000000001',200,'g',6,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000006','60000000-0000-0000-0000-000000000002',3,'pcs',6,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000006','60000000-0000-0000-0000-000000000007',80,'g',6,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000006','60000000-0000-0000-0000-00000000000b',10,'g',6,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000006','60000000-0000-0000-0000-000000000003',50,'ml',6,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000007','60000000-0000-0000-0000-00000000000f',300,'g',7,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000007','60000000-0000-0000-0000-000000000001',250,'g',7,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000007','60000000-0000-0000-0000-000000000007',100,'g',7,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000007','60000000-0000-0000-0000-000000000005',200,'g',7,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000007','60000000-0000-0000-0000-000000000003',150,'ml',7,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000008','60000000-0000-0000-0000-000000000001',200,'g',8,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000008','60000000-0000-0000-0000-000000000005',150,'g',8,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000008','60000000-0000-0000-0000-00000000000b',15,'g',8,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000008','60000000-0000-0000-0000-00000000000c',80,'g',8,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000008','60000000-0000-0000-0000-000000000006',50,'g',8,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000009','60000000-0000-0000-0000-000000000009',200,'g',9,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000009','60000000-0000-0000-0000-00000000000a',150,'g',9,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000009','60000000-0000-0000-0000-00000000000b',10,'g',9,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000009','60000000-0000-0000-0000-00000000000c',50,'g',9,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000010','60000000-0000-0000-0000-000000000009',200,'g',16,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000010','60000000-0000-0000-0000-00000000000a',200,'g',16,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000010','60000000-0000-0000-0000-000000000002',2,'pcs',16,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000010','60000000-0000-0000-0000-00000000000b',10,'g',16,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000011','60000000-0000-0000-0000-000000000011',200,'g',17,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000011','60000000-0000-0000-0000-000000000005',150,'g',17,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000011','60000000-0000-0000-0000-00000000000c',80,'g',17,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000011','60000000-0000-0000-0000-00000000000b',10,'g',17,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000012','60000000-0000-0000-0000-000000000004',250,'g',18,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000012','60000000-0000-0000-0000-000000000005',100,'g',18,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000012','60000000-0000-0000-0000-00000000000b',15,'g',18,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000012','60000000-0000-0000-0000-000000000007',60,'g',18,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000012','60000000-0000-0000-0000-000000000006',50,'g',18,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000013','60000000-0000-0000-0000-000000000001',200,'g',19,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000013','60000000-0000-0000-0000-000000000003',150,'ml',19,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000013','60000000-0000-0000-0000-000000000002',2,'pcs',19,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000013','60000000-0000-0000-0000-00000000000b',10,'g',19,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000014','60000000-0000-0000-0000-000000000001',200,'g',20,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000014','60000000-0000-0000-0000-000000000002',3,'pcs',20,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000014','60000000-0000-0000-0000-000000000003',100,'ml',20,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000014','60000000-0000-0000-0000-000000000008',50,'g',20,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000015','60000000-0000-0000-0000-000000000001',150,'g',21,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000015','60000000-0000-0000-0000-000000000002',4,'pcs',21,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000015','60000000-0000-0000-0000-000000000007',200,'g',21,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000015','60000000-0000-0000-0000-000000000003',100,'ml',21,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000015','60000000-0000-0000-0000-000000000012',80,'g',21,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000016','60000000-0000-0000-0000-000000000001',200,'g',22,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000016','60000000-0000-0000-0000-000000000002',3,'pcs',22,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000016','60000000-0000-0000-0000-000000000003',100,'ml',22,NULL,now()),
  ('a1b2c3d4-0000-0000-0000-000000000016','60000000-0000-0000-0000-000000000008',60,'g',22,NULL,now())
ON CONFLICT (recipe_id, ingredient_id) DO NOTHING;

-- Extra ingredients: complete recipes 047–05a
INSERT INTO recipe_ingredients (recipe_id, ingredient_id, quantity, unit, updated_at, deleted_at, server_updated_at) VALUES
  ('70000000-0000-0000-0000-000000000047','60000000-0000-0000-0000-000000000003',100,'ml',71,NULL,now()),
  ('70000000-0000-0000-0000-000000000048','60000000-0000-0000-0000-000000000005',100,'g',72,NULL,now()),
  ('70000000-0000-0000-0000-000000000049','60000000-0000-0000-0000-00000000000c',50,'g',73,NULL,now()),
  ('70000000-0000-0000-0000-00000000004a','60000000-0000-0000-0000-00000000000c',60,'g',74,NULL,now()),
  ('70000000-0000-0000-0000-00000000004b','60000000-0000-0000-0000-00000000000f',100,'g',75,NULL,now()),
  ('70000000-0000-0000-0000-00000000004b','60000000-0000-0000-0000-00000000000b',10,'g',75,NULL,now()),
  ('70000000-0000-0000-0000-00000000004c','60000000-0000-0000-0000-00000000000b',10,'g',76,NULL,now()),
  ('70000000-0000-0000-0000-00000000004d','60000000-0000-0000-0000-00000000000b',10,'g',77,NULL,now()),
  ('70000000-0000-0000-0000-00000000004e','60000000-0000-0000-0000-000000000003',50,'ml',78,NULL,now()),
  ('70000000-0000-0000-0000-00000000004f','60000000-0000-0000-0000-00000000000a',150,'g',79,NULL,now()),
  ('70000000-0000-0000-0000-000000000050','60000000-0000-0000-0000-000000000003',50,'ml',80,NULL,now()),
  ('70000000-0000-0000-0000-000000000051','60000000-0000-0000-0000-000000000012',80,'g',81,NULL,now()),
  ('70000000-0000-0000-0000-000000000052','60000000-0000-0000-0000-000000000008',20,'g',82,NULL,now()),
  ('70000000-0000-0000-0000-000000000053','60000000-0000-0000-0000-00000000000b',10,'g',83,NULL,now()),
  ('70000000-0000-0000-0000-000000000054','60000000-0000-0000-0000-00000000000b',10,'g',84,NULL,now()),
  ('70000000-0000-0000-0000-000000000055','60000000-0000-0000-0000-000000000007',40,'g',85,NULL,now()),
  ('70000000-0000-0000-0000-000000000056','60000000-0000-0000-0000-00000000000c',80,'g',86,NULL,now()),
  ('70000000-0000-0000-0000-000000000057','60000000-0000-0000-0000-000000000003',80,'ml',87,NULL,now()),
  ('70000000-0000-0000-0000-000000000058','60000000-0000-0000-0000-000000000005',150,'g',88,NULL,now()),
  ('70000000-0000-0000-0000-000000000059','60000000-0000-0000-0000-00000000000a',150,'g',89,NULL,now()),
  ('70000000-0000-0000-0000-00000000005a','60000000-0000-0000-0000-000000000008',30,'g',90,NULL,now())
ON CONFLICT (recipe_id, ingredient_id) DO NOTHING;

-- Extra steps: named recipes 001–014
INSERT INTO recipe_steps (uuid, recipe_id, order_index, instruction, updated_at, deleted_at, server_updated_at) VALUES
  ('80000000-0000-0000-0000-00000000003e','70000000-0000-0000-0000-000000000001',3,'Season with soy sauce and garnish with sesame seeds to serve',1,NULL,now()),
  ('80000000-0000-0000-0000-00000000003f','70000000-0000-0000-0000-000000000002',2,'Mix diced tomato and greens with chicken; dress with olive oil',2,NULL,now()),
  ('80000000-0000-0000-0000-000000000040','70000000-0000-0000-0000-000000000002',3,'Season to taste and serve immediately',2,NULL,now()),
  ('80000000-0000-0000-0000-000000000041','70000000-0000-0000-0000-000000000003',2,'Blend the soup until smooth; season with salt and pepper',3,NULL,now()),
  ('80000000-0000-0000-0000-000000000042','70000000-0000-0000-0000-000000000003',3,'Serve hot with crusty bread',3,NULL,now()),
  ('80000000-0000-0000-0000-000000000043','70000000-0000-0000-0000-000000000004',2,'Add garlic and bell pepper; toss 2 min over high heat',4,NULL,now()),
  ('80000000-0000-0000-0000-000000000044','70000000-0000-0000-0000-000000000004',3,'Drizzle with soy sauce and serve over rice',4,NULL,now()),
  ('80000000-0000-0000-0000-000000000045','70000000-0000-0000-0000-000000000005',2,'Pour egg and milk mixture into pan; cook low and slow',5,NULL,now()),
  ('80000000-0000-0000-0000-000000000046','70000000-0000-0000-0000-000000000005',3,'Fold and serve with a sprinkle of fresh herbs',5,NULL,now()),
  ('80000000-0000-0000-0000-000000000047','70000000-0000-0000-0000-000000000006',2,'Lightly toast the nuts in a dry pan for 3 min',6,NULL,now()),
  ('80000000-0000-0000-0000-000000000048','70000000-0000-0000-0000-000000000006',3,'Combine with yogurt and serve as a snack',6,NULL,now()),
  ('80000000-0000-0000-0000-000000000049','70000000-0000-0000-0000-000000000007',2,'Stir in eggs and almond; simmer on low for 10 min',7,NULL,now()),
  ('80000000-0000-0000-0000-00000000004a','70000000-0000-0000-0000-000000000007',3,'Add sugar to taste and serve warm or chilled',7,NULL,now()),
  ('80000000-0000-0000-0000-00000000004b','70000000-0000-0000-0000-000000000008',2,'Roll dough into balls and place on a lined tray',8,NULL,now()),
  ('80000000-0000-0000-0000-00000000004c','70000000-0000-0000-0000-000000000008',3,'Bake at 180°C for 12 min until golden; cool on a rack',8,NULL,now()),
  ('80000000-0000-0000-0000-00000000004d','70000000-0000-0000-0000-000000000009',2,'Layer pasta sheets, spinach filling and cheese; repeat',9,NULL,now()),
  ('80000000-0000-0000-0000-00000000004e','70000000-0000-0000-0000-000000000009',3,'Bake at 190°C for 35 min until bubbling; rest 10 min',9,NULL,now()),
  ('80000000-0000-0000-0000-00000000004f','70000000-0000-0000-0000-00000000000a',2,'Push rice to one side; scramble eggs in the cleared space',10,NULL,now()),
  ('80000000-0000-0000-0000-000000000050','70000000-0000-0000-0000-00000000000a',3,'Combine everything, add garlic and soy sauce; toss 2 min',10,NULL,now()),
  ('80000000-0000-0000-0000-000000000051','70000000-0000-0000-0000-00000000000b',2,'Add onion and bell pepper; cook 5 min until softened',11,NULL,now()),
  ('80000000-0000-0000-0000-000000000052','70000000-0000-0000-0000-00000000000b',3,'Deglaze with stock and simmer 5 min; serve hot',11,NULL,now()),
  ('80000000-0000-0000-0000-000000000053','70000000-0000-0000-0000-00000000000c',2,'Add cooked rice to the pan; stir-fry everything 3 min',12,NULL,now()),
  ('80000000-0000-0000-0000-000000000054','70000000-0000-0000-0000-00000000000c',3,'Drizzle with sesame oil and serve in bowls',12,NULL,now()),
  ('80000000-0000-0000-0000-000000000055','70000000-0000-0000-0000-00000000000d',2,'Add garlic and onion; stir-fry 2 min until fragrant',13,NULL,now()),
  ('80000000-0000-0000-0000-000000000056','70000000-0000-0000-0000-00000000000d',3,'Toss with soy sauce and serve over steamed rice',13,NULL,now()),
  ('80000000-0000-0000-0000-000000000057','70000000-0000-0000-0000-00000000000e',2,'Simmer shrimp and tomato with garlic for 8 min',14,NULL,now()),
  ('80000000-0000-0000-0000-000000000058','70000000-0000-0000-0000-00000000000e',3,'Fold in spinach at the end; season and serve',14,NULL,now()),
  ('80000000-0000-0000-0000-000000000059','70000000-0000-0000-0000-00000000000f',2,'Stir cheese into oats and mix well',15,NULL,now()),
  ('80000000-0000-0000-0000-00000000005a','70000000-0000-0000-0000-00000000000f',3,'Fold in wilted spinach and serve topped with a poached egg',15,NULL,now()),
  ('80000000-0000-0000-0000-00000000005b','70000000-0000-0000-0000-000000000010',2,'Add tomatoes and stock; simmer 20 min until lentils are soft',16,NULL,now()),
  ('80000000-0000-0000-0000-00000000005c','70000000-0000-0000-0000-000000000010',3,'Blend partially for texture; season and serve with bread',16,NULL,now()),
  ('80000000-0000-0000-0000-00000000005d','70000000-0000-0000-0000-000000000011',2,'Toast oats in a dry pan until golden; cool',17,NULL,now()),
  ('80000000-0000-0000-0000-00000000005e','70000000-0000-0000-0000-000000000011',3,'Layer yogurt with oats, almonds and a drizzle of honey',17,NULL,now()),
  ('80000000-0000-0000-0000-00000000005f','70000000-0000-0000-0000-000000000012',2,'Mix rice, broccoli, cheese and milk in a baking dish',18,NULL,now()),
  ('80000000-0000-0000-0000-000000000060','70000000-0000-0000-0000-000000000012',3,'Bake at 180°C for 20 min until golden and bubbly',18,NULL,now()),
  ('80000000-0000-0000-0000-000000000061','70000000-0000-0000-0000-000000000013',2,'Add cheese and tomato to the egg wrap; cook 1 min more',19,NULL,now()),
  ('80000000-0000-0000-0000-000000000062','70000000-0000-0000-0000-000000000013',3,'Roll tightly and slice in half to serve',19,NULL,now()),
  ('80000000-0000-0000-0000-000000000063','70000000-0000-0000-0000-000000000014',2,'Flake pan-seared salmon over the warm lentils',20,NULL,now()),
  ('80000000-0000-0000-0000-000000000064','70000000-0000-0000-0000-000000000014',3,'Dress with lemon and garlic; toss gently and serve',20,NULL,now())
ON CONFLICT (uuid) DO NOTHING;

-- Steps: test recipes 015–046 (3 per recipe)
INSERT INTO recipe_steps (uuid, recipe_id, order_index, instruction, updated_at, deleted_at, server_updated_at) VALUES
  ('80000000-0000-0000-0000-000000000065','70000000-0000-0000-0000-000000000015',1,'Prepare and chop all ingredients',21,NULL,now()),
  ('80000000-0000-0000-0000-000000000066','70000000-0000-0000-0000-000000000015',2,'Cook main ingredients over medium heat until done',21,NULL,now()),
  ('80000000-0000-0000-0000-000000000067','70000000-0000-0000-0000-000000000015',3,'Season to taste, plate and serve',21,NULL,now()),
  ('80000000-0000-0000-0000-000000000068','70000000-0000-0000-0000-000000000016',1,'Prepare and chop all ingredients',22,NULL,now()),
  ('80000000-0000-0000-0000-000000000069','70000000-0000-0000-0000-000000000016',2,'Cook main ingredients over medium heat until done',22,NULL,now()),
  ('80000000-0000-0000-0000-00000000006a','70000000-0000-0000-0000-000000000016',3,'Season to taste, plate and serve',22,NULL,now()),
  ('80000000-0000-0000-0000-00000000006b','70000000-0000-0000-0000-000000000017',1,'Prepare and chop all ingredients',23,NULL,now()),
  ('80000000-0000-0000-0000-00000000006c','70000000-0000-0000-0000-000000000017',2,'Cook main ingredients over medium heat until done',23,NULL,now()),
  ('80000000-0000-0000-0000-00000000006d','70000000-0000-0000-0000-000000000017',3,'Season to taste, plate and serve',23,NULL,now()),
  ('80000000-0000-0000-0000-00000000006e','70000000-0000-0000-0000-000000000018',1,'Prepare and chop all ingredients',24,NULL,now()),
  ('80000000-0000-0000-0000-00000000006f','70000000-0000-0000-0000-000000000018',2,'Cook main ingredients over medium heat until done',24,NULL,now()),
  ('80000000-0000-0000-0000-000000000070','70000000-0000-0000-0000-000000000018',3,'Season to taste, plate and serve',24,NULL,now()),
  ('80000000-0000-0000-0000-000000000071','70000000-0000-0000-0000-000000000019',1,'Prepare and chop all ingredients',25,NULL,now()),
  ('80000000-0000-0000-0000-000000000072','70000000-0000-0000-0000-000000000019',2,'Cook main ingredients over medium heat until done',25,NULL,now()),
  ('80000000-0000-0000-0000-000000000073','70000000-0000-0000-0000-000000000019',3,'Season to taste, plate and serve',25,NULL,now()),
  ('80000000-0000-0000-0000-000000000074','70000000-0000-0000-0000-00000000001a',1,'Prepare and chop all ingredients',26,NULL,now()),
  ('80000000-0000-0000-0000-000000000075','70000000-0000-0000-0000-00000000001a',2,'Cook main ingredients over medium heat until done',26,NULL,now()),
  ('80000000-0000-0000-0000-000000000076','70000000-0000-0000-0000-00000000001a',3,'Season to taste, plate and serve',26,NULL,now()),
  ('80000000-0000-0000-0000-000000000077','70000000-0000-0000-0000-00000000001b',1,'Prepare and chop all ingredients',27,NULL,now()),
  ('80000000-0000-0000-0000-000000000078','70000000-0000-0000-0000-00000000001b',2,'Cook main ingredients over medium heat until done',27,NULL,now()),
  ('80000000-0000-0000-0000-000000000079','70000000-0000-0000-0000-00000000001b',3,'Season to taste, plate and serve',27,NULL,now()),
  ('80000000-0000-0000-0000-00000000007a','70000000-0000-0000-0000-00000000001c',1,'Prepare and chop all ingredients',28,NULL,now()),
  ('80000000-0000-0000-0000-00000000007b','70000000-0000-0000-0000-00000000001c',2,'Cook main ingredients over medium heat until done',28,NULL,now()),
  ('80000000-0000-0000-0000-00000000007c','70000000-0000-0000-0000-00000000001c',3,'Season to taste, plate and serve',28,NULL,now()),
  ('80000000-0000-0000-0000-00000000007d','70000000-0000-0000-0000-00000000001d',1,'Prepare and chop all ingredients',29,NULL,now()),
  ('80000000-0000-0000-0000-00000000007e','70000000-0000-0000-0000-00000000001d',2,'Cook main ingredients over medium heat until done',29,NULL,now()),
  ('80000000-0000-0000-0000-00000000007f','70000000-0000-0000-0000-00000000001d',3,'Season to taste, plate and serve',29,NULL,now()),
  ('80000000-0000-0000-0000-000000000080','70000000-0000-0000-0000-00000000001e',1,'Prepare and chop all ingredients',30,NULL,now()),
  ('80000000-0000-0000-0000-000000000081','70000000-0000-0000-0000-00000000001e',2,'Cook main ingredients over medium heat until done',30,NULL,now()),
  ('80000000-0000-0000-0000-000000000082','70000000-0000-0000-0000-00000000001e',3,'Season to taste, plate and serve',30,NULL,now()),
  ('80000000-0000-0000-0000-000000000083','70000000-0000-0000-0000-00000000001f',1,'Marinate and season the protein',31,NULL,now()),
  ('80000000-0000-0000-0000-000000000084','70000000-0000-0000-0000-00000000001f',2,'Sauté vegetables alongside until tender',31,NULL,now()),
  ('80000000-0000-0000-0000-000000000085','70000000-0000-0000-0000-00000000001f',3,'Combine, adjust seasoning and serve hot',31,NULL,now()),
  ('80000000-0000-0000-0000-000000000086','70000000-0000-0000-0000-000000000020',1,'Marinate and season the protein',32,NULL,now()),
  ('80000000-0000-0000-0000-000000000087','70000000-0000-0000-0000-000000000020',2,'Sauté vegetables alongside until tender',32,NULL,now()),
  ('80000000-0000-0000-0000-000000000088','70000000-0000-0000-0000-000000000020',3,'Combine, adjust seasoning and serve hot',32,NULL,now()),
  ('80000000-0000-0000-0000-000000000089','70000000-0000-0000-0000-000000000021',1,'Marinate and season the protein',33,NULL,now()),
  ('80000000-0000-0000-0000-00000000008a','70000000-0000-0000-0000-000000000021',2,'Sauté vegetables alongside until tender',33,NULL,now()),
  ('80000000-0000-0000-0000-00000000008b','70000000-0000-0000-0000-000000000021',3,'Combine, adjust seasoning and serve hot',33,NULL,now()),
  ('80000000-0000-0000-0000-00000000008c','70000000-0000-0000-0000-000000000022',1,'Marinate and season the protein',34,NULL,now()),
  ('80000000-0000-0000-0000-00000000008d','70000000-0000-0000-0000-000000000022',2,'Sauté vegetables alongside until tender',34,NULL,now()),
  ('80000000-0000-0000-0000-00000000008e','70000000-0000-0000-0000-000000000022',3,'Combine, adjust seasoning and serve hot',34,NULL,now()),
  ('80000000-0000-0000-0000-00000000008f','70000000-0000-0000-0000-000000000023',1,'Marinate and season the protein',35,NULL,now()),
  ('80000000-0000-0000-0000-000000000090','70000000-0000-0000-0000-000000000023',2,'Sauté vegetables alongside until tender',35,NULL,now()),
  ('80000000-0000-0000-0000-000000000091','70000000-0000-0000-0000-000000000023',3,'Combine, adjust seasoning and serve hot',35,NULL,now()),
  ('80000000-0000-0000-0000-000000000092','70000000-0000-0000-0000-000000000024',1,'Marinate and season the protein',36,NULL,now()),
  ('80000000-0000-0000-0000-000000000093','70000000-0000-0000-0000-000000000024',2,'Sauté vegetables alongside until tender',36,NULL,now()),
  ('80000000-0000-0000-0000-000000000094','70000000-0000-0000-0000-000000000024',3,'Combine, adjust seasoning and serve hot',36,NULL,now()),
  ('80000000-0000-0000-0000-000000000095','70000000-0000-0000-0000-000000000025',1,'Marinate and season the protein',37,NULL,now()),
  ('80000000-0000-0000-0000-000000000096','70000000-0000-0000-0000-000000000025',2,'Sauté vegetables alongside until tender',37,NULL,now()),
  ('80000000-0000-0000-0000-000000000097','70000000-0000-0000-0000-000000000025',3,'Combine, adjust seasoning and serve hot',37,NULL,now()),
  ('80000000-0000-0000-0000-000000000098','70000000-0000-0000-0000-000000000026',1,'Marinate and season the protein',38,NULL,now()),
  ('80000000-0000-0000-0000-000000000099','70000000-0000-0000-0000-000000000026',2,'Sauté vegetables alongside until tender',38,NULL,now()),
  ('80000000-0000-0000-0000-00000000009a','70000000-0000-0000-0000-000000000026',3,'Combine, adjust seasoning and serve hot',38,NULL,now()),
  ('80000000-0000-0000-0000-00000000009b','70000000-0000-0000-0000-000000000027',1,'Marinate and season the protein',39,NULL,now()),
  ('80000000-0000-0000-0000-00000000009c','70000000-0000-0000-0000-000000000027',2,'Sauté vegetables alongside until tender',39,NULL,now()),
  ('80000000-0000-0000-0000-00000000009d','70000000-0000-0000-0000-000000000027',3,'Combine, adjust seasoning and serve hot',39,NULL,now()),
  ('80000000-0000-0000-0000-00000000009e','70000000-0000-0000-0000-000000000028',1,'Marinate and season the protein',40,NULL,now()),
  ('80000000-0000-0000-0000-00000000009f','70000000-0000-0000-0000-000000000028',2,'Sauté vegetables alongside until tender',40,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a0','70000000-0000-0000-0000-000000000028',3,'Combine, adjust seasoning and serve hot',40,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a1','70000000-0000-0000-0000-000000000029',1,'Sauté aromatics in oil until fragrant',41,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a2','70000000-0000-0000-0000-000000000029',2,'Add main ingredients and simmer 15 min',41,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a3','70000000-0000-0000-0000-000000000029',3,'Finish with herbs, season and plate',41,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a4','70000000-0000-0000-0000-00000000002a',1,'Sauté aromatics in oil until fragrant',42,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a5','70000000-0000-0000-0000-00000000002a',2,'Add main ingredients and simmer 15 min',42,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a6','70000000-0000-0000-0000-00000000002a',3,'Finish with herbs, season and plate',42,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a7','70000000-0000-0000-0000-00000000002b',1,'Sauté aromatics in oil until fragrant',43,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a8','70000000-0000-0000-0000-00000000002b',2,'Add main ingredients and simmer 15 min',43,NULL,now()),
  ('80000000-0000-0000-0000-0000000000a9','70000000-0000-0000-0000-00000000002b',3,'Finish with herbs, season and plate',43,NULL,now()),
  ('80000000-0000-0000-0000-0000000000aa','70000000-0000-0000-0000-00000000002c',1,'Sauté aromatics in oil until fragrant',44,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ab','70000000-0000-0000-0000-00000000002c',2,'Add main ingredients and simmer 15 min',44,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ac','70000000-0000-0000-0000-00000000002c',3,'Finish with herbs, season and plate',44,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ad','70000000-0000-0000-0000-00000000002d',1,'Sauté aromatics in oil until fragrant',45,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ae','70000000-0000-0000-0000-00000000002d',2,'Add main ingredients and simmer 15 min',45,NULL,now()),
  ('80000000-0000-0000-0000-0000000000af','70000000-0000-0000-0000-00000000002d',3,'Finish with herbs, season and plate',45,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b0','70000000-0000-0000-0000-00000000002e',1,'Sauté aromatics in oil until fragrant',46,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b1','70000000-0000-0000-0000-00000000002e',2,'Add main ingredients and simmer 15 min',46,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b2','70000000-0000-0000-0000-00000000002e',3,'Finish with herbs, season and plate',46,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b3','70000000-0000-0000-0000-00000000002f',1,'Sauté aromatics in oil until fragrant',47,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b4','70000000-0000-0000-0000-00000000002f',2,'Add main ingredients and simmer 15 min',47,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b5','70000000-0000-0000-0000-00000000002f',3,'Finish with herbs, season and plate',47,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b6','70000000-0000-0000-0000-000000000030',1,'Sauté aromatics in oil until fragrant',48,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b7','70000000-0000-0000-0000-000000000030',2,'Add main ingredients and simmer 15 min',48,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b8','70000000-0000-0000-0000-000000000030',3,'Finish with herbs, season and plate',48,NULL,now()),
  ('80000000-0000-0000-0000-0000000000b9','70000000-0000-0000-0000-000000000031',1,'Sauté aromatics in oil until fragrant',49,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ba','70000000-0000-0000-0000-000000000031',2,'Add main ingredients and simmer 15 min',49,NULL,now()),
  ('80000000-0000-0000-0000-0000000000bb','70000000-0000-0000-0000-000000000031',3,'Finish with herbs, season and plate',49,NULL,now()),
  ('80000000-0000-0000-0000-0000000000bc','70000000-0000-0000-0000-000000000032',1,'Sauté aromatics in oil until fragrant',50,NULL,now()),
  ('80000000-0000-0000-0000-0000000000bd','70000000-0000-0000-0000-000000000032',2,'Add main ingredients and simmer 15 min',50,NULL,now()),
  ('80000000-0000-0000-0000-0000000000be','70000000-0000-0000-0000-000000000032',3,'Finish with herbs, season and plate',50,NULL,now()),
  ('80000000-0000-0000-0000-0000000000bf','70000000-0000-0000-0000-000000000033',1,'Bring liquid to a boil, add ingredients',51,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c0','70000000-0000-0000-0000-000000000033',2,'Reduce heat, cover and cook until tender',51,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c1','70000000-0000-0000-0000-000000000033',3,'Rest 5 min, garnish and serve',51,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c2','70000000-0000-0000-0000-000000000034',1,'Bring liquid to a boil, add ingredients',52,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c3','70000000-0000-0000-0000-000000000034',2,'Reduce heat, cover and cook until tender',52,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c4','70000000-0000-0000-0000-000000000034',3,'Rest 5 min, garnish and serve',52,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c5','70000000-0000-0000-0000-000000000035',1,'Bring liquid to a boil, add ingredients',53,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c6','70000000-0000-0000-0000-000000000035',2,'Reduce heat, cover and cook until tender',53,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c7','70000000-0000-0000-0000-000000000035',3,'Rest 5 min, garnish and serve',53,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c8','70000000-0000-0000-0000-000000000036',1,'Bring liquid to a boil, add ingredients',54,NULL,now()),
  ('80000000-0000-0000-0000-0000000000c9','70000000-0000-0000-0000-000000000036',2,'Reduce heat, cover and cook until tender',54,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ca','70000000-0000-0000-0000-000000000036',3,'Rest 5 min, garnish and serve',54,NULL,now()),
  ('80000000-0000-0000-0000-0000000000cb','70000000-0000-0000-0000-000000000037',1,'Bring liquid to a boil, add ingredients',55,NULL,now()),
  ('80000000-0000-0000-0000-0000000000cc','70000000-0000-0000-0000-000000000037',2,'Reduce heat, cover and cook until tender',55,NULL,now()),
  ('80000000-0000-0000-0000-0000000000cd','70000000-0000-0000-0000-000000000037',3,'Rest 5 min, garnish and serve',55,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ce','70000000-0000-0000-0000-000000000038',1,'Bring liquid to a boil, add ingredients',56,NULL,now()),
  ('80000000-0000-0000-0000-0000000000cf','70000000-0000-0000-0000-000000000038',2,'Reduce heat, cover and cook until tender',56,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d0','70000000-0000-0000-0000-000000000038',3,'Rest 5 min, garnish and serve',56,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d1','70000000-0000-0000-0000-000000000039',1,'Bring liquid to a boil, add ingredients',57,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d2','70000000-0000-0000-0000-000000000039',2,'Reduce heat, cover and cook until tender',57,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d3','70000000-0000-0000-0000-000000000039',3,'Rest 5 min, garnish and serve',57,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d4','70000000-0000-0000-0000-00000000003a',1,'Bring liquid to a boil, add ingredients',58,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d5','70000000-0000-0000-0000-00000000003a',2,'Reduce heat, cover and cook until tender',58,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d6','70000000-0000-0000-0000-00000000003a',3,'Rest 5 min, garnish and serve',58,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d7','70000000-0000-0000-0000-00000000003b',1,'Bring liquid to a boil, add ingredients',59,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d8','70000000-0000-0000-0000-00000000003b',2,'Reduce heat, cover and cook until tender',59,NULL,now()),
  ('80000000-0000-0000-0000-0000000000d9','70000000-0000-0000-0000-00000000003b',3,'Rest 5 min, garnish and serve',59,NULL,now()),
  ('80000000-0000-0000-0000-0000000000da','70000000-0000-0000-0000-00000000003c',1,'Bring liquid to a boil, add ingredients',60,NULL,now()),
  ('80000000-0000-0000-0000-0000000000db','70000000-0000-0000-0000-00000000003c',2,'Reduce heat, cover and cook until tender',60,NULL,now()),
  ('80000000-0000-0000-0000-0000000000dc','70000000-0000-0000-0000-00000000003c',3,'Rest 5 min, garnish and serve',60,NULL,now()),
  ('80000000-0000-0000-0000-0000000000dd','70000000-0000-0000-0000-00000000003d',1,'Combine dry and wet components',61,NULL,now()),
  ('80000000-0000-0000-0000-0000000000de','70000000-0000-0000-0000-00000000003d',2,'Cook over medium heat until golden or set',61,NULL,now()),
  ('80000000-0000-0000-0000-0000000000df','70000000-0000-0000-0000-00000000003d',3,'Remove from heat, garnish and serve warm',61,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e0','70000000-0000-0000-0000-00000000003e',1,'Combine dry and wet components',62,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e1','70000000-0000-0000-0000-00000000003e',2,'Cook over medium heat until golden or set',62,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e2','70000000-0000-0000-0000-00000000003e',3,'Remove from heat, garnish and serve warm',62,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e3','70000000-0000-0000-0000-00000000003f',1,'Combine dry and wet components',63,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e4','70000000-0000-0000-0000-00000000003f',2,'Cook over medium heat until golden or set',63,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e5','70000000-0000-0000-0000-00000000003f',3,'Remove from heat, garnish and serve warm',63,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e6','70000000-0000-0000-0000-000000000040',1,'Combine dry and wet components',64,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e7','70000000-0000-0000-0000-000000000040',2,'Cook over medium heat until golden or set',64,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e8','70000000-0000-0000-0000-000000000040',3,'Remove from heat, garnish and serve warm',64,NULL,now()),
  ('80000000-0000-0000-0000-0000000000e9','70000000-0000-0000-0000-000000000041',1,'Combine dry and wet components',65,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ea','70000000-0000-0000-0000-000000000041',2,'Cook over medium heat until golden or set',65,NULL,now()),
  ('80000000-0000-0000-0000-0000000000eb','70000000-0000-0000-0000-000000000041',3,'Remove from heat, garnish and serve warm',65,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ec','70000000-0000-0000-0000-000000000042',1,'Combine dry and wet components',66,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ed','70000000-0000-0000-0000-000000000042',2,'Cook over medium heat until golden or set',66,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ee','70000000-0000-0000-0000-000000000042',3,'Remove from heat, garnish and serve warm',66,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ef','70000000-0000-0000-0000-000000000043',1,'Combine dry and wet components',67,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f0','70000000-0000-0000-0000-000000000043',2,'Cook over medium heat until golden or set',67,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f1','70000000-0000-0000-0000-000000000043',3,'Remove from heat, garnish and serve warm',67,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f2','70000000-0000-0000-0000-000000000044',1,'Combine dry and wet components',68,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f3','70000000-0000-0000-0000-000000000044',2,'Cook over medium heat until golden or set',68,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f4','70000000-0000-0000-0000-000000000044',3,'Remove from heat, garnish and serve warm',68,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f5','70000000-0000-0000-0000-000000000045',1,'Combine dry and wet components',69,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f6','70000000-0000-0000-0000-000000000045',2,'Cook over medium heat until golden or set',69,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f7','70000000-0000-0000-0000-000000000045',3,'Remove from heat, garnish and serve warm',69,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f8','70000000-0000-0000-0000-000000000046',1,'Combine dry and wet components',70,NULL,now()),
  ('80000000-0000-0000-0000-0000000000f9','70000000-0000-0000-0000-000000000046',2,'Cook over medium heat until golden or set',70,NULL,now()),
  ('80000000-0000-0000-0000-0000000000fa','70000000-0000-0000-0000-000000000046',3,'Remove from heat, garnish and serve warm',70,NULL,now())
ON CONFLICT (uuid) DO NOTHING;

-- Steps: featured recipes a001–a016 (3 per recipe)
INSERT INTO recipe_steps (uuid, recipe_id, order_index, instruction, updated_at, deleted_at, server_updated_at) VALUES
  ('80000000-0000-0000-0000-0000000000fb','a1b2c3d4-0000-0000-0000-000000000001',1,'Heat olive oil, sauté garlic and onion until soft',1,NULL,now()),
  ('80000000-0000-0000-0000-0000000000fc','a1b2c3d4-0000-0000-0000-000000000001',2,'Add shrimp, chorizo and rice; pour in warm stock and saffron',1,NULL,now()),
  ('80000000-0000-0000-0000-0000000000fd','a1b2c3d4-0000-0000-0000-000000000001',3,'Simmer uncovered 20 min; add seafood for last 5 min and rest before serving',1,NULL,now()),
  ('80000000-0000-0000-0000-0000000000fe','a1b2c3d4-0000-0000-0000-000000000002',1,'Marinate chicken in lemon juice, garlic and herbs for 30 min',2,NULL,now()),
  ('80000000-0000-0000-0000-0000000000ff','a1b2c3d4-0000-0000-0000-000000000002',2,'Grill over high heat 5–6 min per side until cooked through',2,NULL,now()),
  ('80000000-0000-0000-0000-000000000100','a1b2c3d4-0000-0000-0000-000000000002',3,'Rest 5 min, slice and serve with roasted vegetables',2,NULL,now()),
  ('80000000-0000-0000-0000-000000000101','a1b2c3d4-0000-0000-0000-000000000003',1,'Blend green curry paste with garlic and ginger; fry 2 min',3,NULL,now()),
  ('80000000-0000-0000-0000-000000000102','a1b2c3d4-0000-0000-0000-000000000003',2,'Add coconut milk and chicken; simmer 15 min until cooked',3,NULL,now()),
  ('80000000-0000-0000-0000-000000000103','a1b2c3d4-0000-0000-0000-000000000003',3,'Stir in spinach and bell pepper; serve over jasmine rice',3,NULL,now()),
  ('80000000-0000-0000-0000-000000000104','a1b2c3d4-0000-0000-0000-000000000004',1,'Make dough from flour, water and yeast; knead and prove 1 hour',4,NULL,now()),
  ('80000000-0000-0000-0000-000000000105','a1b2c3d4-0000-0000-0000-000000000004',2,'Roll dough thin, spread tomato sauce and add cheese',4,NULL,now()),
  ('80000000-0000-0000-0000-000000000106','a1b2c3d4-0000-0000-0000-000000000004',3,'Bake at 250°C for 10 min until base is crisp and cheese bubbles',4,NULL,now()),
  ('80000000-0000-0000-0000-000000000107','a1b2c3d4-0000-0000-0000-000000000005',1,'Brown beef in batches in a heavy pot; remove and set aside',5,NULL,now()),
  ('80000000-0000-0000-0000-000000000108','a1b2c3d4-0000-0000-0000-000000000005',2,'Sauté onion and garlic; add tomatoes, stock and beef back in',5,NULL,now()),
  ('80000000-0000-0000-0000-000000000109','a1b2c3d4-0000-0000-0000-000000000005',3,'Cover and simmer on low for 1.5 hours until beef is tender',5,NULL,now()),
  ('80000000-0000-0000-0000-00000000010a','a1b2c3d4-0000-0000-0000-000000000006',1,'Cook pasta in salted water; reserve 1 cup pasta water',6,NULL,now()),
  ('80000000-0000-0000-0000-00000000010b','a1b2c3d4-0000-0000-0000-000000000006',2,'Whisk eggs with Parmesan and black pepper for the sauce',6,NULL,now()),
  ('80000000-0000-0000-0000-00000000010c','a1b2c3d4-0000-0000-0000-000000000006',3,'Toss hot pasta with guanciale, remove from heat, add egg sauce slowly',6,NULL,now()),
  ('80000000-0000-0000-0000-00000000010d','a1b2c3d4-0000-0000-0000-000000000007',1,'Brown meat and make béchamel sauce separately',7,NULL,now()),
  ('80000000-0000-0000-0000-00000000010e','a1b2c3d4-0000-0000-0000-000000000007',2,'Layer pasta, meat sauce and béchamel; repeat layers',7,NULL,now()),
  ('80000000-0000-0000-0000-00000000010f','a1b2c3d4-0000-0000-0000-000000000007',3,'Top with cheese and bake at 180°C for 45 min; rest 15 min',7,NULL,now()),
  ('80000000-0000-0000-0000-000000000110','a1b2c3d4-0000-0000-0000-000000000008',1,'Brown sausage with garlic and onion until fragrant',8,NULL,now()),
  ('80000000-0000-0000-0000-000000000111','a1b2c3d4-0000-0000-0000-000000000008',2,'Add tomatoes and sun-dried tomatoes; simmer 10 min',8,NULL,now()),
  ('80000000-0000-0000-0000-000000000112','a1b2c3d4-0000-0000-0000-000000000008',3,'Toss with cooked pasta, fold in spinach and serve',8,NULL,now()),
  ('80000000-0000-0000-0000-000000000113','a1b2c3d4-0000-0000-0000-000000000009',1,'Mix soy sauce, mirin and sugar for teriyaki glaze',9,NULL,now()),
  ('80000000-0000-0000-0000-000000000114','a1b2c3d4-0000-0000-0000-000000000009',2,'Pan-fry salmon skin-side down 4 min, flip and glaze',9,NULL,now()),
  ('80000000-0000-0000-0000-000000000115','a1b2c3d4-0000-0000-0000-000000000009',3,'Cook 3 min more, glaze again and serve over steamed rice',9,NULL,now()),
  ('80000000-0000-0000-0000-000000000116','a1b2c3d4-0000-0000-0000-000000000010',1,'Season and shape sushi rice with rice vinegar',16,NULL,now()),
  ('80000000-0000-0000-0000-000000000117','a1b2c3d4-0000-0000-0000-000000000010',2,'Top rice with sliced fresh fish pressed firmly',16,NULL,now()),
  ('80000000-0000-0000-0000-000000000118','a1b2c3d4-0000-0000-0000-000000000010',3,'Serve immediately with soy sauce, wasabi and ginger',16,NULL,now()),
  ('80000000-0000-0000-0000-000000000119','a1b2c3d4-0000-0000-0000-000000000011',1,'Devein shrimp and marinate in citrus juice for 15 min',17,NULL,now()),
  ('80000000-0000-0000-0000-00000000011a','a1b2c3d4-0000-0000-0000-000000000011',2,'Add diced onion and garlic; mix and chill 10 min more',17,NULL,now()),
  ('80000000-0000-0000-0000-00000000011b','a1b2c3d4-0000-0000-0000-000000000011',3,'Stir in tomato, season with salt and serve cold',17,NULL,now()),
  ('80000000-0000-0000-0000-00000000011c','a1b2c3d4-0000-0000-0000-000000000012',1,'Marinate chicken in lemon juice, olive oil and herbs',18,NULL,now()),
  ('80000000-0000-0000-0000-00000000011d','a1b2c3d4-0000-0000-0000-000000000012',2,'Grill 5 min per side; add olives and feta in last 2 min',18,NULL,now()),
  ('80000000-0000-0000-0000-00000000011e','a1b2c3d4-0000-0000-0000-000000000012',3,'Serve over spinach with a drizzle of olive oil',18,NULL,now()),
  ('80000000-0000-0000-0000-00000000011f','a1b2c3d4-0000-0000-0000-000000000013',1,'Make beer batter from flour, eggs and cold beer',19,NULL,now()),
  ('80000000-0000-0000-0000-000000000120','a1b2c3d4-0000-0000-0000-000000000013',2,'Pat cod dry, dip in batter and shake off excess',19,NULL,now()),
  ('80000000-0000-0000-0000-000000000121','a1b2c3d4-0000-0000-0000-000000000013',3,'Deep-fry at 180°C for 4–5 min until golden; drain on paper',19,NULL,now()),
  ('80000000-0000-0000-0000-000000000122','a1b2c3d4-0000-0000-0000-000000000014',1,'Cream butter and sugar until fluffy; beat in eggs and milk',20,NULL,now()),
  ('80000000-0000-0000-0000-000000000123','a1b2c3d4-0000-0000-0000-000000000014',2,'Fold in flour and chocolate chips to form a soft dough',20,NULL,now()),
  ('80000000-0000-0000-0000-000000000124','a1b2c3d4-0000-0000-0000-000000000014',3,'Drop spoonfuls on a tray; bake at 175°C for 11 min',20,NULL,now()),
  ('80000000-0000-0000-0000-000000000125','a1b2c3d4-0000-0000-0000-000000000015',1,'Crush biscuits and mix with butter; press into tin and chill',21,NULL,now()),
  ('80000000-0000-0000-0000-000000000126','a1b2c3d4-0000-0000-0000-000000000015',2,'Beat cream cheese, eggs, sugar and yogurt until smooth',21,NULL,now()),
  ('80000000-0000-0000-0000-000000000127','a1b2c3d4-0000-0000-0000-000000000015',3,'Pour over base, bake at 160°C for 50 min; cool then top with blueberries',21,NULL,now()),
  ('80000000-0000-0000-0000-000000000128','a1b2c3d4-0000-0000-0000-000000000016',1,'Melt chocolate and butter; stir in sugar and eggs',22,NULL,now()),
  ('80000000-0000-0000-0000-000000000129','a1b2c3d4-0000-0000-0000-000000000016',2,'Fold in flour and almond until just combined',22,NULL,now()),
  ('80000000-0000-0000-0000-00000000012a','a1b2c3d4-0000-0000-0000-000000000016',3,'Drop onto lined tray; bake at 175°C for 11 min; cool on rack',22,NULL,now())
ON CONFLICT (uuid) DO NOTHING;

-- Extra step 3: complete recipes 047–05a
INSERT INTO recipe_steps (uuid, recipe_id, order_index, instruction, updated_at, deleted_at, server_updated_at) VALUES
  ('80000000-0000-0000-0000-00000000012b','70000000-0000-0000-0000-000000000047',3,'Garnish with fresh coriander and serve with basmati rice',71,NULL,now()),
  ('80000000-0000-0000-0000-00000000012c','70000000-0000-0000-0000-000000000048',3,'Garnish with sour cream and lime wedges; serve immediately',72,NULL,now()),
  ('80000000-0000-0000-0000-00000000012d','70000000-0000-0000-0000-000000000049',3,'Drizzle with extra-virgin olive oil and serve with flatbread',73,NULL,now()),
  ('80000000-0000-0000-0000-00000000012e','70000000-0000-0000-0000-00000000004a',3,'Drizzle with olive oil, garnish with basil and serve hot',74,NULL,now()),
  ('80000000-0000-0000-0000-00000000012f','70000000-0000-0000-0000-00000000004b',3,'Ladle into crocks, top with croutons and melted Gruyère, then serve',75,NULL,now()),
  ('80000000-0000-0000-0000-000000000130','70000000-0000-0000-0000-00000000004c',3,'Sprinkle with Parmesan and croutons; serve immediately',76,NULL,now()),
  ('80000000-0000-0000-0000-000000000131','70000000-0000-0000-0000-00000000004d',3,'Stir in coconut milk, simmer 5 more min and serve over rice',77,NULL,now()),
  ('80000000-0000-0000-0000-000000000132','70000000-0000-0000-0000-00000000004e',3,'Plate salmon alongside broccoli; squeeze lemon over and serve',78,NULL,now()),
  ('80000000-0000-0000-0000-000000000133','70000000-0000-0000-0000-00000000004f',3,'Top with pickles and sauce of choice; serve in a bowl',79,NULL,now()),
  ('80000000-0000-0000-0000-000000000134','70000000-0000-0000-0000-000000000050',3,'Toast bread, layer with spinach and eggs, add cheese and serve',80,NULL,now()),
  ('80000000-0000-0000-0000-000000000135','70000000-0000-0000-0000-000000000051',3,'Pipe or spoon into glasses; chill 2 hours before serving',81,NULL,now()),
  ('80000000-0000-0000-0000-000000000136','70000000-0000-0000-0000-000000000052',3,'Stack pancakes with almond butter, maple syrup and fresh fruit',82,NULL,now()),
  ('80000000-0000-0000-0000-000000000137','70000000-0000-0000-0000-000000000053',3,'Blend partially for a creamy texture; ladle into bowls and serve',83,NULL,now()),
  ('80000000-0000-0000-0000-000000000138','70000000-0000-0000-0000-000000000054',3,'Top with a soft-boiled egg or sesame seeds; serve warm',84,NULL,now()),
  ('80000000-0000-0000-0000-000000000139','70000000-0000-0000-0000-000000000055',3,'Wrap tightly in foil; cut in half diagonally to serve',85,NULL,now()),
  ('80000000-0000-0000-0000-00000000013a','70000000-0000-0000-0000-000000000056',3,'Sprinkle with fresh parsley and serve straight from the pan with bread',86,NULL,now()),
  ('80000000-0000-0000-0000-00000000013b','70000000-0000-0000-0000-000000000057',3,'Add a drizzle of honey and a pinch of cinnamon to finish',87,NULL,now()),
  ('80000000-0000-0000-0000-00000000013c','70000000-0000-0000-0000-000000000058',3,'Rest 5 min after baking; serve with a green salad',88,NULL,now()),
  ('80000000-0000-0000-0000-00000000013d','70000000-0000-0000-0000-000000000059',3,'Transfer to a serving plate, garnish with spring onion and sesame seeds',89,NULL,now()),
  ('80000000-0000-0000-0000-00000000013e','70000000-0000-0000-0000-00000000005a',3,'Stir well, top with fresh fruit or nuts and enjoy cold',90,NULL,now())
ON CONFLICT (uuid) DO NOTHING;
